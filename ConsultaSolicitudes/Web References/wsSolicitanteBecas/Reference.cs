...
namespace ConsultaSolicitudes.wsSolicitanteBecas {
    using System;
    ...
    public partial class SolicitantesBecas : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback listaCompletaOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public SolicitantesBecas() {
            this.Url = global::ConsultaSolicitudes.Properties.Settings.Default.wsSolicitantesBecas;
        ...
        /// <remarks/>
        public event listaCompletaCompletedEventHandler listaCompletaCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://wsSolicitantesBecas.net/listaCompleta", RequestNamespace="http://wsSolicitantesBecas.net/", ResponseNamespace="http://wsSolicitantesBecas.net/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public StcListaRegistrosCompleta listaCompleta() {
            object[] results = this.Invoke("listaCompleta", new object[0]);
            return ((StcListaRegistrosCompleta)(results[0]));
        }
        
        /// <remarks/>
        public void listaCompletaAsync() {
            this.listaCompletaAsync(null);
        }
        
        /// <remarks/>
        public void listaCompletaAsync(object userState) {
            if ((this.listaCompletaOperationCompleted == null)) {
                this.listaCompletaOperationCompleted = new System.Threading.SendOrPostCallback(this.OnlistaCompletaOperationCompleted);
            }
            this.InvokeAsync("listaCompleta", new object[0], this.listaCompletaOperationCompleted, userState);
        }
        
        private void OnlistaCompletaOperationCompleted(object arg) {
            if ((this.listaCompletaCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.listaCompletaCompleted(this, new listaCompletaCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    public partial class vwSolicitudes {
        ...
        public string calles {
            get {
                return this.callesField;
            }
            set {
                this.callesField = value;
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://wsSolicitantesBecas.net/")]
    public partial class StcListaRegistrosCompleta {
        
        private structBase statusResponseField;
        
        private vwSolicitudes[] dataField;
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void listaCompletaCompletedEventHandler(object sender, listaCompletaCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class listaCompletaCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal listaCompletaCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public StcListaRegistrosCompleta Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((StcListaRegistrosCompleta)(this.results[0]));
            }
        }
    }
}
